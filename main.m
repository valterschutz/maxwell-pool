...
for t=0:dt:2
    ...
    test_ball1.E = E(test_ball1.pos, que_ball);
    test_ball1.B = B(test_ball1.pos, que_ball);
    ...
    test_ball2.E = E(test_ball2.pos, que_ball);
    test_ball2.B = B(test_ball2.pos, que_ball);
