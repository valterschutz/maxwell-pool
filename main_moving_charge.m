...
test_ball2.m = 0.1;
test_ball2.q = 1e-3;
test_ball2.x = vector_to_multivector([0.2;0.6;0.4]);
test_ball2.v = vector_to_multivector([0.01;-0.01;0.02]);
...
for t=0:DT:T
    ...
    test_ball1.force = test_ball1.q*(test_ball1.E+cross(test_ball1.v, test_ball1.B));
